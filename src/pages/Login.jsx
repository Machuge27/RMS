    ...
    <div className="login-container">
      <div className="login-box">
        ...
        <div className="dev-notice" style={{
          ...
          <h4 style={{ margin: "0 0 8px 0" }}>🚧 Development Mode 🚧</h4>
          <p style={{ margin: "0 0 8px 0", fontSize: "14px" }}>
            This application is still under development. For testing purposes, you can use:
          </p>
